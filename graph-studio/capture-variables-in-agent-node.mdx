...
<Frame caption="AI Derived capture — name and description">
  <img src="/images/Screenshot2026-02-11at7.21.22PM.png" alt="AI Derived variables configuration" />
</Frame>
...
<Frame caption="Referred capture — copy from an existing session variable">
  <img src="/images/Screenshot2026-02-11at7.24.09PM.png" alt="Referred variables configuration" />
</Frame>
...
<Frame caption="Fixed value capture — static constant for the session">
  <img src="/images/Screenshot2026-02-11at7.25.30PM.png" alt="Fixed value variables configuration" />
</Frame>
