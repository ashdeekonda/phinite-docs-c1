...
<Frame caption="AI Derived capture — name and description">
  ![AI Derived variables configuration](/images/Screenshot2026-02-11at7.21.22PM.png)
</Frame>
...
<Frame caption="Referred capture — copy from an existing session variable">
  ![Referred variables configuration](/images/Screenshot2026-02-11at7.24.09PM.png)
</Frame>
...
<Frame caption="Fixed value capture — static constant for the session">
  ![Fixed value variables configuration](/images/Screenshot2026-02-11at7.25.30PM.png)
</Frame>
