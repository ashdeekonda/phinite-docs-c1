...
<CardGroup cols={2}>
  ...
  <Card title="End Flow Tool" icon="circle-stop">
    Terminate the entire workflow
  </Card>
  <Card title="Flow Insight Tool" icon="comment-dots">
...
<AccordionGroup>
  ...
  <Accordion title="Flow Insight Messages">
...
<ResponseField name="Flow Insight messages not appearing">
