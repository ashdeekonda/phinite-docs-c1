...
**Organization** → **Workspaces** → **Projects** → **Assets (Agent Graphs, Tools, Assistants)**
...
Each workspace includes: •	Graph Studio: Visual designer for agent workflows. •	DevStudio: Tool & integration builder. •	Datasources: Document collections and RAG knowledge bases. •	Environments: Separate runtime spaces (Dev / UAT / Prod). •	Observability: Logs, sessions, and metrics.
