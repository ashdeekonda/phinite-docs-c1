...
Phinite's **Notion** predefined tool lets workspace agent graphs call Notion APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
