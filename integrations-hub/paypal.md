...
Phinite's **PayPal** predefined tool lets workspace agent graphs call PayPal APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
