...
Phinite's **Brave Search** predefined tool lets workspace agent graphs call Brave Search APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
