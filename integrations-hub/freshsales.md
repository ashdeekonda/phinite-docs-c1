...
Phinite's **Freshsales CRM** predefined tool lets workspace agent graphs call Freshsales CRM APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
