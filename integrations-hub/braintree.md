...
Phinite's **Braintree** predefined tool lets workspace agent graphs call Braintree APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
