...
Phinite's **Zoom** predefined tool lets workspace agent graphs call Zoom APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
