...
Phinite's **Razorpay** predefined tool lets workspace agent graphs call Razorpay APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
