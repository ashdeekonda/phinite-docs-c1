...
Phinite's **Tableau** predefined tool lets workspace agent graphs call Tableau APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
