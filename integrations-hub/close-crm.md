...
Phinite's **Close CRM** predefined tool lets workspace agent graphs call Close CRM APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
