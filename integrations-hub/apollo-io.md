...
Phinite's **Apollo.io** predefined tool lets workspace agent graphs call Apollo.io APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
