...
Phinite's **Facebook Messenger** predefined tool lets workspace agent graphs call Facebook Messenger APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
