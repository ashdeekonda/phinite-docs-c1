...
Phinite's **Firecrawl** predefined tool lets workspace agent graphs call Firecrawl APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
