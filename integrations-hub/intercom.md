...
Phinite's **Intercom** predefined tool lets workspace agent graphs call Intercom APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
