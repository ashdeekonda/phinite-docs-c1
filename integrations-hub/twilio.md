...
Phinite's **Twilio** predefined tool lets workspace agent graphs call Twilio APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
