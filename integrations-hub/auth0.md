...
Phinite's **Auth0** predefined tool lets workspace agent graphs call Auth0 APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
