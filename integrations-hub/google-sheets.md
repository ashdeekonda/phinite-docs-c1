...
Phinite's **Google Sheets** predefined tool lets workspace agent graphs call Google Sheets APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
