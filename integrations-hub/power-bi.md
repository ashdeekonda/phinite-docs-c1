...
Phinite's **Power BI** predefined tool lets workspace agent graphs call Power BI APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
