...
Phinite's **SendGrid** predefined tool lets workspace agent graphs call SendGrid APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
