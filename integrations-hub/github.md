...
Phinite's **GitHub** predefined tool lets workspace agent graphs call GitHub APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
