...
Phinite's **Gorgias** predefined tool lets workspace agent graphs call Gorgias APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
