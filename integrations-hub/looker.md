...
Phinite's **Looker** predefined tool lets workspace agent graphs call Looker APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
