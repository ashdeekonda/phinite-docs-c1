...
Phinite's **Google Cloud** predefined tool lets workspace agent graphs call Google Cloud APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
