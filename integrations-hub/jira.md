...
Phinite's **Jira** predefined tool lets workspace agent graphs call Jira APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
