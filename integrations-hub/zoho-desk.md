...
Phinite's **Zoho Desk** predefined tool lets workspace agent graphs call Zoho Desk APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
