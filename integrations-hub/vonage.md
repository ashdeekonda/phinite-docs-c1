...
Phinite's **Vonage** predefined tool lets workspace agent graphs call Vonage APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
