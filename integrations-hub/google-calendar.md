...
Phinite's **Google Calendar** predefined tool lets workspace agent graphs call Google Calendar APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
