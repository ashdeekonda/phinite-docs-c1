...
Phinite's **Help Scout** predefined tool lets workspace agent graphs call Help Scout APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
