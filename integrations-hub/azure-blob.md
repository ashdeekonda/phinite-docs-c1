...
Phinite's **Azure Blob Storage** predefined tool lets workspace agent graphs call Azure Blob Storage APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
