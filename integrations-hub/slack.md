...
Phinite's **Slack** predefined tool lets workspace agent graphs call Slack APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
