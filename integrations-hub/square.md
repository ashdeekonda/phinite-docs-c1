...
Phinite's **Square** predefined tool lets workspace agent graphs call Square APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
