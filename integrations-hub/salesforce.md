...
Phinite's **Salesforce** predefined tool lets workspace agent graphs call Salesforce APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
