...
Phinite's **Gmail** predefined tool lets workspace agent graphs call Gmail APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
