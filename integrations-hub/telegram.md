...
Phinite's **Telegram** predefined tool lets workspace agent graphs call Telegram APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
