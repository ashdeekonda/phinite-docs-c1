...
Phinite's **Outreach** predefined tool lets workspace agent graphs call Outreach APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
