...
Phinite's **Docker** predefined tool lets workspace agent graphs call Docker APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
