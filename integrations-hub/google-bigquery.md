...
Phinite's **Google BigQuery** predefined tool lets workspace agent graphs call Google BigQuery APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
