...
Phinite's **Instagram** predefined tool lets workspace agent graphs call Instagram APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
