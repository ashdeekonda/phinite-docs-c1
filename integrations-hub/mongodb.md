...
Phinite's **MongoDB** predefined tool lets workspace agent graphs call MongoDB APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
