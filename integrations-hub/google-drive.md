...
Phinite's **Google Drive** predefined tool lets workspace agent graphs call Google Drive APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
