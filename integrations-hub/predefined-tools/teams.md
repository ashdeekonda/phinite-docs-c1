...
<Note>
This legacy Teams tool variant is superseded by the **Microsoft Teams** predefined tool. See [Microsoft Teams](/integrations-hub/predefined-tools/microsoft-teams) for the recommended integration.
</Note>
...
- Phinite documentation: [Microsoft Teams](https://docs.phinite.ai/docs/integrations-hub/predefined-tools/teams)
