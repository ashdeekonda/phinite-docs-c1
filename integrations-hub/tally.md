...
Phinite's **Tally** predefined tool lets workspace agent graphs call Tally APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
