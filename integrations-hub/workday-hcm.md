...
Phinite's **Workday HCM** predefined tool lets workspace agent graphs call Workday HCM APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
