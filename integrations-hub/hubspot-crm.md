...
Phinite's **HubSpot CRM** predefined tool lets workspace agent graphs call HubSpot CRM APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
