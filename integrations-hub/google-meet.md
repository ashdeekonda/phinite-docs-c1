...
Phinite's **Google Meet** predefined tool lets workspace agent graphs call Google Meet APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
