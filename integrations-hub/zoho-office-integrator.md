...
Phinite's **Zoho Office Integrator** predefined tool lets workspace agent graphs call Zoho Office Integrator APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
