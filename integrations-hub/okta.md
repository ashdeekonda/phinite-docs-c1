...
Phinite's **Okta** predefined tool lets workspace agent graphs call Okta APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
