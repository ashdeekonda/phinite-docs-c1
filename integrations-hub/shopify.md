...
Phinite's **Shopify** predefined tool lets workspace agent graphs call Shopify APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
