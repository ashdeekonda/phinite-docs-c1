...
Phinite's **Pipedrive** predefined tool lets workspace agent graphs call Pipedrive APIs through DevStudio after you save a connection under **Integrations → Predefined tools**.
