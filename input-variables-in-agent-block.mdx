---
title: "Input Variables in Agent Block"
---

<img
  src="/images/Screenshot2026-02-11at6.44.29PM.png"
  alt="Agent Block Input Variables Configuration"
  title="Agent Block Input Variables"
  style={{ width: "51%" }}
/>
...
<AccordionGroup>
  ...
  <Accordion title="User Variables (Flow API)">
