...
See **[Endpoints & lifecycle](/agent-registry/publish#hosted-urls-and-lifecycle)** for URL and auth details.
...
After promotion, refresh the table and verify the **live** hosted URL on the build row or in **[Agent Registry](/agent-registry/compose#catalog)**.
...
2. **[Expose as External Agent](/agent-registry/publish#expose-wizard)** via **Configure Agent** → **Create New Build**.
