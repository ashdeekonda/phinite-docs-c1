---
title: "Capture Variables in Agent Block"
---
...
Referred variables allow you to copy the value from an existing session variable. This is useful when you need to pass data between agent blocks or reuse existing values.
